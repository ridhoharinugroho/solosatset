...
import {
  ...
  trackUserInterest,
  getUserTopInterests,
} from "./productInterestTracker.js";
...
export function openProductDetail(listingId) {
  ...
  if (negoBadge) {
    const negoLabel =
      listing.negoType === "pas" ? "Nett" : negoObj ? negoObj.short || negoObj.label.split("(")[0].trim() : "Bisa Nego";
