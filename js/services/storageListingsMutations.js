  ...
  if (supabase) {
    (async () => {
      ...
      if (
        ...
        finalImages.some((img) => typeof img === "string" && img.startsWith("data:"))
      ) {
        try {
...
export function updateListing(id, updatedFields) {
  ...
  if (supabase) {
    (async () => {
      if (
        updatedFieldsCopy.images &&
        Array.isArray(updatedFieldsCopy.images) &&
        updatedFieldsCopy.images.some((img) => typeof img === "string" && img.startsWith("data:"))
      ) {
        try {
      ...
      if (updatedFieldsCopy.negoType !== undefined || updatedFieldsCopy.nego_type !== undefined)
        cleanUpdatePayload.nego_type = updatedFieldsCopy.negoType || updatedFieldsCopy.nego_type;
      if (updatedFieldsCopy.paymentMethod !== undefined || updatedFieldsCopy.payment_method !== undefined)
        cleanUpdatePayload.payment_method =
          updatedFieldsCopy.payment_method || updatedFieldsCopy.paymentMethod || "cod";
      if (updatedFieldsCopy.regionId !== undefined || updatedFieldsCopy.region !== undefined)
        cleanUpdatePayload.region = updatedFieldsCopy.regionId || updatedFieldsCopy.region;
      if (updatedFieldsCopy.district !== undefined) cleanUpdatePayload.district = updatedFieldsCopy.district;
      if (updatedFieldsCopy.codPoint !== undefined || updatedFieldsCopy.cod_point !== undefined)
        cleanUpdatePayload.cod_point = updatedFieldsCopy.cod_point || updatedFieldsCopy.codPoint || "";
      if (updatedFieldsCopy.storeMapsUrl !== undefined || updatedFieldsCopy.store_maps_url !== undefined)
        cleanUpdatePayload.store_maps_url = updatedFieldsCopy.store_maps_url || updatedFieldsCopy.storeMapsUrl || "";
      ...
      if (updatedFieldsCopy.bu_expires_at !== undefined)
        cleanUpdatePayload.bu_expires_at = updatedFieldsCopy.bu_expires_at;
      if (updatedFieldsCopy.payment_amount !== undefined)
        cleanUpdatePayload.payment_amount = updatedFieldsCopy.payment_amount;
      if (updatedFieldsCopy.payment_status !== undefined)
        cleanUpdatePayload.payment_status = updatedFieldsCopy.payment_status;
      if (updatedFieldsCopy.qris_verified !== undefined || updatedFieldsCopy.isQrisVerified !== undefined)
        cleanUpdatePayload.qris_verified = Boolean(updatedFieldsCopy.qris_verified || updatedFieldsCopy.isQrisVerified);

      const activeUser = getCurrentUser();
      if (activeUser?.id) cleanUpdatePayload.seller_id = activeUser.id;
      if (activeUser?.storeName || activeUser?.name)
        cleanUpdatePayload.seller_name = activeUser.storeName || activeUser.name;
