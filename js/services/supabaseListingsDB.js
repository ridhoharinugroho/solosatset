...
export async function sbSaveListing(listing) {
  ...
  const insertPayload = {
    ...
    region: listing.regionId || listing.region || "",
    district: listing.district || "",
    province_code: listing.province_code || listing.provinceCode || null,
    regency_code: listing.regency_code || listing.regencyCode || null,
    district_code: listing.district_code || listing.districtCode || null,
    village: listing.village || null,
