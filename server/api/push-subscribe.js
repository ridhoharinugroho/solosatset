...
export default async function handler(req, res) {
  ...
  if (req.method === "GET") {
    ...
    return res
      .status(200)
      .json({
        service: "SOPALOKA - Web Push Subscription Engine",
  ...
  try {
    ...
    if (!user || user.deleted_at || String(user.status || "active").toLowerCase() === "deleted")
        ...
        [
          {
            ...
            user_agent: String(req.headers["user-agent"] || "unknown").slice(0, 500),
